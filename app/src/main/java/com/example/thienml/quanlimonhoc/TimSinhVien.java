...
public class TimSinhVien extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public static Intent newIntent(Context context) {
        Intent intent = new Intent(context, TimSinhVien.class);
        return intent;
    }
